<h3>Users</h3>
<ul class="toggle">
	<li class="icn_add_user"><a href="<?php echo base_url(); echo index_page(); echo "/";?>cms/new_user">Add New User</a></li>
	<li class="icn_add_user"><a href="<?php echo base_url(); echo index_page(); echo "/";?>cms/new_admin">Add New Admin</a></li>
